...
@MainActor
final class SkillsPanelPresenter {
    private var panel: NSPanel?

    func show(model: OverlayViewModel, anchorWindow: NSWindow?, onClose: @escaping () -> Void) {
        let size = NSSize(width: OverlayLayout.skillsPanelWidth, height: OverlayLayout.skillsPanelHeight)
        ...
        let hostingView = MovableHostingView(rootView: SkillsPanel(model: model, onClose: onClose))
